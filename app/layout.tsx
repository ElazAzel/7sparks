...
export const metadata: Metadata = {
  ...
  description:
    "Documentolog AI summer camp × Jedai Academy: 29+ авторов, 9 премьерных слотов. AI Film Festival 2026. 27-31 июля.",
  manifest: "/manifest.json",
  openGraph: {
    title: "9 ИСКР — Documentolog AI summer camp",
    description:
      "29+ юных авторов. Девять премьерных слотов. AI Film Festival 2026. 27-31 июля.",
    type: "website",
    locale: "ru_RU",
  },
};
